...
import com.redbeeacademy.algoritmostest.Lista.EjercicioCine.Resultado;
...
class CineTest {
    ...
    public void testHappyPathCantidadPersonas() {
       Resultado result = Cine.cantidadPersonas(List.of(new Persona(30), new Persona(17), new Persona(8), new Persona(18) ));
        //assertNotNull(result, "The result cannot be null");
    ...
    public void testNullValuesCantidadPersonas() {
        Resultado result = Cine.cantidadPersonas(Arrays.asList(new Persona(30), null, new Persona(8), new Persona(18) ));  // consultar cuál es el problema.-
        assertNotNull(result, "The result cannot be null");
        assertEquals(1, ((Resultado) result).getCantNiños());
    ...
    public void testNullValuesPromedioEdad() {
        Double result = Cine.promedioEdad(Arrays.asList(new Persona(30), null, new Persona(8), new Persona(18) ));  // consultar cuál es el problema.-
        assertNotNull(result, "The result cannot be null");
